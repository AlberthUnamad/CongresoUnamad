<fieldset class="formulario__fieldset">
    ...
    <?php if(isset($ponente->imagen_actual)) { ?>
        ...
        <div class="formulario__imagen">
            <picture>
                <source srcset="<?php echo $_ENV['HOST'] . '/img/ponentesC/' . $ponente->imagen; ?>.webp" type="image/webp">
                <source srcset="<?php echo $_ENV['HOST'] . '/img/ponentesC/' . $ponente->imagen; ?>.png" type="image/png">
                <img src="<?php echo $_ENV['HOST'] . '/img/ponentesC/' . $ponente->imagen; ?>.png" alt="Imagen Ponente">
            </picture>
        </div>
